...
import { SessionExpiredPanel } from '@/components/dashboard/SessionExpiredPanel';
            ...
            <>
              <div className="mb-14 max-w-3xl">
                ...
                <p className="mt-6 max-w-2xl border-l-2 border-red-800 pl-5 leading-7 text-zinc-400">
                  El inicio de sesión fue exitoso. El JWT
                  permanece protegido dentro de una cookie
                  HTTP-only y se envía automáticamente en cada
              ...
              <footer className="mt-14 border-t border-red-950 pt-6">
                <p className="font-mono text-[10px] uppercase tracking-[0.25em] text-zinc-700">
                  Autenticación centralizada · AES-256-CBC ·
